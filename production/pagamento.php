...
require_once './PagSeguro/Library.php';
require_once './PagSeguro/Helpers/Validate.php';
require_once './PagSeguro/Resources/Framework/ContentManagementSystems.php';
require_once './PagSeguro/Resources/Framework/Platform/Factory.php';
...
//Add metadata items
$payment->addMetadata()->withParameters('PASSENGER_CPF', '22317063857');
