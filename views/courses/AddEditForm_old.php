            ...
            <form action="" id="course" method="POST" enctype="multipart/form-data" >
                ...
                <div class="row">
                    <div class="form-group col-lg-5">
                        ...
                        <textarea rows="10" maxlength="400"  class="form-control editable" id="shortDescription" name="shortDescription" 
                    ...
                    <div class="form-group col-lg-5">
                        ...
                        <div id="smallPicturePreview">
                            <img widht="370" height="200" id="smallPicturePreviewing" src="<?php echo isset($this->data) ? "/public/upload/" . $this->data['smallPicture'] : false; ?>" />
                            <p id="message"></p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-lg-5">
                        ...
                        <textarea rows="10" maxlength="400"  class="form-control editable" id="longDescription" name="longDescription" 
                    ...
                    <div class="form-group col-lg-5">
                        ...
                        <div id="largePicturePreview">
                            <img widht="370" height="200" id="largePicturePreviewing" src="<?php echo isset($this->data) ?  "/public/upload/" . $this->data['largePicture'] : false; ?>" />
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-lg-3 ">
                        ...
                        <textarea rows="3" maxlength="400"  class="form-control editable" id="dateTime" name="dateTime" 
                                  placeholder=""><?php echo isset($this->data) ? $this->data['dateTimeDesc'] : false; ?></textarea>
                    </div>
                    <div class="form-group col-lg-3">
                        <label for="loadTime">Carga Horária</label>
                        <textarea rows="3" maxlength="400"  class="form-control editable" id="loadTime" name="loadTime" 
                                  placeholder=""><?php echo isset($this->data) ? $this->data['loadTimeDesc'] : false; ?></textarea>
                    </div>
                    <div class="form-group col-lg-3">
                        <label for="material">Material</label>
                        <textarea rows="3" maxlength="400"  class="form-control editable" id="material" name="material" 
                                  placeholder=""><?php echo isset($this->data) ? $this->data['materialDesc'] : false; ?></textarea>
                    </div>
                    <div class="form-group col-lg-3">
                        <label for="target">Público Alvo</label>
                        <textarea rows="3" maxlength="400"  class="form-control editable" id="target" name="target" 
                ...
                <div class="row">
                    <div class="form-group col-lg-3 ">
                        ...
                        <textarea rows="3" maxlength="400"  class="form-control editable" id="address" name="address" 
                    ...
                    <div class="form-group col-lg-3">
                        ...
                        <textarea rows="3" maxlength="400"  class="form-control editable" id="paymentMethod" name="paymentMethod" 
                                  placeholder=""><?php echo isset($this->data) ? $this->data['paymentMethodDesc'] : false; ?></textarea>
                    </div>
                    <div class="form-group col-lg-3">
                        <label for="teacher">Formadores</label>
                        <textarea rows="3" maxlength="400"  class="form-control editable" id="teacher" name="teacher" 
...
//    Method to define the action of Save button
    ...
    if ($("#courseId").val() === "") {
        ...
        $("#course").attr("action", "/course/insert");
...
// Refatorar a lógica para melhorar o código de carregamento de imagens.
